...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.userjoin":
		if e.complexity.Mutation.Userjoin == nil {
			break
		}

		args, err := field_Mutation_userjoin_args(rawArgs)
		if err != nil {
			return 0, false
		}
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_userjoin(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
