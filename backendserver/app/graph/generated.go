...
type MutationResolver interface {
	PostMessage(ctx context.Context, sender_name string, receiver_name string, message string) (model.Chatconversation, error)
	JoinUser(ctx context.Context, name string) (model.User, error)
}
type QueryResolver interface {
	Users(ctx context.Context) ([]model.User, error)
	Chats(ctx context.Context, sender_name string, receiver_name string) ([]model.Chatconversation, error)
}
type SubscriptionResolver interface {
	Userjoined(ctx context.Context) (<-chan model.User, error)
	MessagePosted(ctx context.Context, id string) (<-chan model.Chatconversation, error)
}
...
// nolint: vetshadow
func (ec *executionContext) _Chatconversation_id(ctx context.Context, field graphql.CollectedField, obj *model.Chatconversation) graphql.Marshaler {
...
// nolint: vetshadow
func (ec *executionContext) _Chatconversation_sender_name(ctx context.Context, field graphql.CollectedField, obj *model.Chatconversation) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Chatconversation",
...
// nolint: vetshadow
func (ec *executionContext) _Chatconversation_receiver_name(ctx context.Context, field graphql.CollectedField, obj *model.Chatconversation) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Chatconversation",
